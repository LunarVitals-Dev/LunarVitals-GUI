...
def init_data_collection_page(self):
    ...
    # Label selection using big buttons with icons
    ...
    # Optionally select a default astronaut
    self.set_current_astronaut("Victor", "Male", 22, 140)
    self.astronaut_buttons["Victor"].setChecked(True)
    self.astronaut_buttons["Victor"].setStyleSheet("padding: 6px; font-size: 12px; border: 2px solid green;")
...
def create_data_labels(self, layout):
    ...
    self.data_labels_layout = layout  # Save for later dynamic population
        ...
        #self.mongo_data_labels[field] = value_label
